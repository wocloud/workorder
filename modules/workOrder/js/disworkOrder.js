...
DisworkOrder.$inject = ['$scope', '$location', '$log', '$cacheFactory', 'MyWorkOrder.RES','$state','i18nService'];
function DisworkOrder($scope, $location, $log, $cacheFactory, myWorkOrderRES,$state,i18nService) {
