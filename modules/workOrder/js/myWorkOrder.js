...
(function(){
    ...
    MyWorkOrderViewCtrl.$inject = ['$scope', 'ngDialog', '$log', 'MyWorkOrder.RES', '$state','i18nService'];
    function MyWorkOrderViewCtrl($scope, ngDialog, $log, myWorkOrderRES, $state,i18nService) {
